# This file moved — the tracker is per-item now

The single planning surface lives at
...
cycle chronicle continues at [`chronicle.md`](chronicle.md). A citation
like "backlog B141" resolves to `projects/vilan/tracker/items/B141.md`
if open, or a tombstone in that tracker's `archive.md` or the frozen
chain if closed.
