...
- RULED 2026-09-13 (owner, Order 34 GO, R10): `dist/.build-hooks.json` is NOT a cache (a §3.3 note, no move); build-hooks Q5 rewritten as overtaken by A65. Lane hygiene-34.
- kind: process
- area: CLI & workflow
