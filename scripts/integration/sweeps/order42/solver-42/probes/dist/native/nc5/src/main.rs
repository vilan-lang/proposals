...
fn cell_9203_0(this: &SignalCell_8212_0, mut context_15357: Option<Turn_7147>, mut context_15378: Option<Owner_7855>) -> SignalCell_8212_0 {
    let cached_9205 = new_8309_0(get_8225_0(&this));
    as_derivation_7079();
    let _owned_9212 = register_with_owner_7971(on_settle_8250_0(&this, mint_subscriber_7109({ let this = (*this).clone(); let cached_9205 = cached_9205.clone(); let context_15357 = context_15357.clone(); std::rc::Rc::new(move || { {
        set_8320_0(&cached_9205, get_8225_0(&this), (context_15357).clone());
    } }) })), (context_15357).clone(), (context_15378).clone());
    cached_9205
}
...
fn main() {
    ...
    let s_15204 = cell_9203_0(&map_8157_d0(&count_15200, { std::rc::Rc::new(move |mut n_15209: i32| { (n_15209 * (10i32)) }) }, None, None), None, None);
    vilan_rt::print(&(get_8225_0(&s_15204)));
