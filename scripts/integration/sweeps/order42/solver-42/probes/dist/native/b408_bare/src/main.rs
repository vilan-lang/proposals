...
fn through_9322_0(mut s_9323: Root_9305) -> i32 {
    let (a_9328, b_9329,) = twice_9315_0(&s_9323);
    (a_9328 + b_9329)
}

fn twice_9315_0(this: &Root_9305) -> (i32, i32) {
...
fn main() {
    vilan_rt::main_guard(|| {
    vilan_rt::print(&(through_9322_0(Root_9305 { v: (2i32) })));
